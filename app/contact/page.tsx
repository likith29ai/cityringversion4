          ...
          <div className="relative rounded-2xl sm:rounded-3xl border border-white/10 bg-white/[0.03] p-10 overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="mt-8 space-y-6 text-white/70 leading-relaxed text-[15.5px]">
                <p>
                  Have a question, a concern, or just want to reach out? We'd love to hear from you. CityRing is built on real relationships — and that starts with us being reachable.
                </p>
              ...
              <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-xs text-white/40">Click to send us an email</div>
                  </div>
                </a>
              ...
              <div className="mt-10 pt-8 border-t border-white/10 text-white/40 text-sm leading-relaxed">
                We typically respond within a few hours during business hours. For urgent matters, a phone call is the fastest way to reach us.
              </div>
